...
|2022.05.25|V3.5|支持欧拉镜像；|
|2022.05.26|V3.6|支持重置SOS功能；|
|2022.08.18|V4.0|实例元数据功能优化；|
|2022.09.30|V4.1|支持跨地域（同账号/跨账号）对等连接；|
|2022.11.17|V4.2|七层负载均衡功能优化；|
|2022.11.17|V4.2.1|支持CentOS 7.9 64位操作系统；|
|2022.11.24|V4.3|支持实例重装系统更换网络配置；|

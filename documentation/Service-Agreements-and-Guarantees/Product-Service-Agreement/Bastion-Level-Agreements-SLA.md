...
（1）一份详细的事件说明报告，包括：实例ID、详细日期、时间、持续时间和其他服务不可用的相关细节。
...
4.1 由于您或您的最终用户对京东云提供的服务造成安全威胁或存在欺诈或者违法行为而导致的服务不可用。

4.2 由于您或者任何第三方（不受京东云直接控制）设备、软件或技术引起的服务不可用。

4.3 由于您未按照京东云规定配置使用产品引起的服务不可用。

4.4 由于您违反任何京东云产品条款引起的服务不可用。

4.5 由于您不付费或是欠款或是退款（包括堡垒机以及本服务所在云服务器）导致的服务不可用。

4.6 由于网络运营商严重故障导致的服务不可用。

4.7 由于您未按规定或者违法使用京东云产品引发的服务不可用。

4.8 由于堡垒机产品框架体系中其他组件的问题（如云服务器被人为关闭、目标服务器访问端口被关闭等）引起的服务不可用。

4.9 使用堡垒机产品的终端自身硬件、操作系统、软件（如 SSH 工具）故障引起的服务不可用。

4.10 由于网络、硬件或服务的维护、升级导致的服务不可用（京东云会按照合理的商业原则给您提前通知关于维护时间的计划）。

4.11 由于不可抗力的原因引起的服务不可用。

4.12 超过您所购堡垒机产品规格的主机管理数导致的服务不可用。

4.13 非京东云原因造成的服务不可用或服务不达标的情况。

4.14 属于相关法律法规、相关协议、相关规则或京东云单独发布的相关规则、说明等中所述的京东云可以免责、免除赔偿责任等的情况。
...
5.3 本协议作为《堡垒机服务条款》的附属协议，具有与《堡垒机服务条款》同等效力，本协议未约定事项，您需遵守《堡垒机服务条款》的相关约定。若本协议与《堡垒机服务条款》中的条款相冲突或不一致，则以本协议为准，但仅在该冲突或不一致范围内适用。

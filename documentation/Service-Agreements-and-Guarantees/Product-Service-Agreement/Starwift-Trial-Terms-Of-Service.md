**本服务条款是京东云计算有限公司（本协议中称为“京东云”网址：www.jdcloud.com ）与您就云原生实时数仓 Starwift 服务相关事项所订立的有效合约。您通过盖章、网络页面点击确认或以其他方式选择接受本服务条款，包括但不限于未点击确认本服务条款而事实上使用了京东云云数据库服务，即表示您与京东云已达成协议并同意接受本服务条款的全部约定内容。如若双方盖章文本与网络页面点击确认或以其他方式选择接受之服务条款文本，存有不一致之处，以双方盖章文本为准。**
...
### 2. 服务费用
2.1 在公测期间，用户可免费试用云原生实时数仓 Starwift 。
2.2 在公测期间，不适用服务等级协议（Service Level Agreement，以下简称 “SLA”），为了数据的安全，请用户自行备份重要数据。

**本服务条款是京东云计算有限公司（本协议中称为“京东云”网址：[www.jdcloud.com](http://www.jdcloud.com/) ）与您就云防火墙服务的相关事项所订立的有效合约。您通过盖章、网络页面点击确认或以其他方式选择接受本服务条款，包括但不限于未点击确认本服务条款而事实上使用了京东云云防火墙服务，即表示您与京东云已达成协议并同意接受本服务条款的全部约定内容。如若双方盖章文本与网络页面点击确认或以其他方式选择接受之服务条款文本，存有不一致之处，以双方盖章文本为准。**

**关于本服务条款，提示您特别关注限制、免责条款，京东云对您违规、违约行为的认定处理条款，以及管辖法院的选择条款等。限制、免责条款可能以加粗或加下划线形式提示您注意。在接受本服务条款之前，请您仔细阅读本服务条款的全部内容。如果您对本服务条款的条款有疑问，请通过致电京东云400-098-8505或发邮件至jdcloud@jd.com进行询问，京东云将向您解释条款内容。如果您不同意本服务条款的任意内容，或者无法准确理解京东云对条款的解释，请不要进行后续操作。**

### 1.服务内容

1.1. 本条款中“服务”指：京东云向您提供[www.jdcloud.com](https://www.jdcloud.com/) 网站上所展示的云防火墙服务以及相关的技术及网络支持服务。

1.2. 京东云提供的服务必须符合本服务条款的约定。

### 2.服务费用

2.1. 云防火墙服务企业版和旗舰版是京东云付费为用户提供VPC边界安全防护服务，在您订购云防火墙实例服务后，需要将您待保护的VPC绑定至云防火墙实例，同时配置路由表项，同时在云防火墙实例上按需开启安全防护功能。

2.2. 您理解并同意，京东云有权根据经营情况，不定期的对云防火墙服务的产品体系、名称或付费模式、价格、可视化界面设计等进行调整。京东云进一步保留在云防火墙服务中开发新的模块、功能等的权利。上述所有新的模块、功能、服务的提供，除非京东云另有说明，否则仍适用本服务条款。京东云将尽合理范围内的最大努力，将前述调整及变化，通过官网公告、站内通知等方式告知您。
...
3.1.3.4. 如您在使用京东云服务时开启云防火墙服务，则您认可并同意遵守《云防火墙服务协议》条款；
...
3.1.3.7.3 封建迷信和/或淫秽、色情、下流的信息或教唆犯罪、电信诈骗的信息；
...
7.1 服务期限自您创建云防火墙实例服务（指[www.jdcloud.com](https://www.jdcloud.com/) 上所向您展示并提供的服务）成功之日起计算，而非以您获得云防火墙实例服务的管理员身份（包括获取了管理员登录号和密码）为依据。具体服务期限将根据您实际使用情况计算。云防火墙实例服务创建成功后，您需进行网站开通前准备的（如办理网站经营许可证/网站备案手续等），准备期间包含在服务期限内。

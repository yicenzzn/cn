...
![demand1](https://jdhelp.s3.cn-north-1.jdcloud-oss.com/demand.assets/manage7.png)
...
点击`拆分`后，显示拆分需求详情页面： ![demand1](https://jdhelp.s3.cn-north-1.jdcloud-oss.com/demand.assets/split1.jpg)

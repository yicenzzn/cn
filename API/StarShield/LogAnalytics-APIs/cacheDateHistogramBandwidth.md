...
## 请求地址
https://starshield.jdcloud-api.com/v1/zones/{zone_identifier}/analytics$$cacheDateHistogramBandwidth
...
|**filters**|[AnalyticsReportingFilter[]](cacheDateHistogramBandwidth#analyticsreportingfilter)|False| | |
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](cacheDateHistogramBandwidth#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**dateHistograms**|[DateHistogram[]](cacheDateHistogramBandwidth#datehistogram)| |
|**timeScope**|Number[]| |
|**since**|String| |
|**util**|String| |

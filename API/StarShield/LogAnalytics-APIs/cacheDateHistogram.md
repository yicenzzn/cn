...
## 请求地址
https://starshield.jdcloud-api.com/v1/zones/{zone_identifier}/analytics$$cacheDateHistogram
...
|**filters**|[AnalyticsReportingFilter[]](cacheDateHistogram#analyticsreportingfilter)|False| | |
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](cacheDateHistogram#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**dateHistograms**|[DateHistogram[]](cacheDateHistogram#datehistogram)| |
|**timeScope**|Number[]| |
|**since**|String| |
|**util**|String| |

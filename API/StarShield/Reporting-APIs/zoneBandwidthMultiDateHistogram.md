...
## 请求地址
https://starshield.jdcloud-api.com/v1/zones/{zone_identifier}/zoneBandwidthMultiDateHistogram
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](zoneBandwidthMultiDateHistogram#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**dateHistograms**|[DateHistogram[]](zoneBandwidthMultiDateHistogram#datehistogram)| |

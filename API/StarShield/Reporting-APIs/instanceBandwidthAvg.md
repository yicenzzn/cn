...
## 请求地址
https://starshield.jdcloud-api.com/v1/instances/{instanceId}/instanceBandwidthAvg
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](instanceBandwidthAvg#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**data**|[CdnSingleMetric](instanceBandwidthAvg#cdnsinglemetric)| |

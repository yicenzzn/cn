...
## 请求地址
https://starshield.jdcloud-api.com/v1/instances/{instanceId}/requestDateHistogramTopK
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](requestDateHistogramTopK#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**dateHistograms**|[DateHistogram[]](requestDateHistogramTopK#datehistogram)| |
|**timeScope**|Number[]| |
|**since**|String| |
|**util**|String| |

...
## 请求地址
https://starshield.jdcloud-api.com/v1/instances/{instanceId}/instanceTrafficMultiDateHistogram
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](instanceTrafficMultiDateHistogram#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**dateHistograms**|[DateHistogram[]](instanceTrafficMultiDateHistogram#datehistogram)| |

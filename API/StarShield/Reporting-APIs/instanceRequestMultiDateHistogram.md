...
## 请求地址
https://starshield.jdcloud-api.com/v1/instances/{instanceId}/instanceRequestMultiDateHistogram
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](instanceRequestMultiDateHistogram#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**dateHistograms**|[DateHistogram[]](instanceRequestMultiDateHistogram#datehistogram)| |

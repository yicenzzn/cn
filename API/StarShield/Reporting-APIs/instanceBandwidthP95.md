...
## 请求地址
https://starshield.jdcloud-api.com/v1/instances/{instanceId}/instanceBandwidthP95
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](instanceBandwidthP95#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**data**|[CdnSingleMetric](instanceBandwidthP95#cdnsinglemetric)| |

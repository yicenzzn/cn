...
## 请求地址
https://starshield.jdcloud-api.com/v1/instances/{instanceId}/instanceBandwidthMultiDateHistogram
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](instanceBandwidthMultiDateHistogram#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**dateHistograms**|[DateHistogram[]](instanceBandwidthMultiDateHistogram#datehistogram)| |

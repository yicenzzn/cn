...
## 请求地址
https://starshield.jdcloud-api.com/v1/instances/{instanceId}/trafficTopK
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](trafficTopK#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**data**|[TopK](trafficTopK#topk)| |
### <div id="topk">TopK</div>
|名称|类型|描述|
|---|---|---|
|**topK**|[Item[]](trafficTopK#item)|排名前K的项。|

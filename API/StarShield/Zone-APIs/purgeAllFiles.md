...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](purgeAllFiles#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**data**|[Zone](purgeAllFiles#zone)| |
### <div id="zone">Zone</div>
|名称|类型|描述|
|---|---|---|
|**plan_pending**|[Plan_pending](purgeAllFiles#plan_pending)| |
...
|名称|类型|描述|
|---|---|---|
|**user_owner**|[User_owner](purgeAllFiles#user_owner)| |
|**organization_owner**|[Organization_owner](purgeAllFiles#organization_owner)| |
